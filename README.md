...
`index.html` é o site inteiro em um único arquivo: HTML, estilos, script, imagens e vídeo já embutidos.
Não precisa de build, servidor ou instalação. Abrir o arquivo no navegador já mostra o site.
